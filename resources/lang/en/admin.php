...
return [
    ...
    'notifications' => [
        ...
        'audience_hint' => 'Leave everything unselected to reach every user of the app. Country/category filtering only reaches devices running the app build that sends those tags.',
        ...
        'push_no_match' => 'The in-app record was written, but no device matched these filters on OneSignal (country/category filtering needs the new app build).',
