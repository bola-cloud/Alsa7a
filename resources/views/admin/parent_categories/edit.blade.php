        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">{{ __('admin.parent_categories.edit') }}</h4>
                </div>
                <div class="card-content collapse show">
                    <div class="card-body">
                        <form action="{{ route('admin.parent_categories.update', $parentCategory->id) }}" method="POST"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="name_en" class="form-control round" name="name[en]"
                                                value="{{ $parentCategory->name_en }}" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="name_ar" class="form-control round" name="name[ar]"
                                                value="{{ $parentCategory->name_ar }}" required>
                                        </div>
                                    </div>
                                </div>
