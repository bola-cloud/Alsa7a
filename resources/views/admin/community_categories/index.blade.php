...
@section('content')
    <div class="content-header row mb-2">
        <div class="content-header-left col-md-6 col-12 mb-2">
            <h3 class="content-header-title text-bold-700">{{ __('admin.community_categories.index') }}</h3>
        </div>
        <div class="content-header-right col-md-6 col-12">
            <div class="btn-group float-md-right">
                <a href="{{ route('admin.community_categories.create') }}" class="btn btn-primary">
                ...
                <div class="modern-card h-100">
                    ...
                    <div class="card-body">
                        ...
                        <div class="card-actions">
                            <a href="{{ route('admin.community_categories.edit', $category->id) }}"
                                class="btn btn-sm btn-outline-primary" title="{{ __('admin.buttons.edit') }}">
                                <i class="la la-edit"></i>
                            </a>

                            <form action="{{ route('admin.community_categories.destroy', $category->id) }}" method="POST"
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body text-center">
                        ...
                        <a href="{{ route('admin.community_categories.create') }}" class="btn btn-primary mt-2">
