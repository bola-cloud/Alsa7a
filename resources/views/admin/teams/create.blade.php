            ...
            <div class="row breadcrumbs-top">
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a
                                 href="{{ route('admin.clubs.teams.index', $club->id) }}">{{ $club->name }} - {{ __('admin.teams.title') }}</a></li>
                        <li class="breadcrumb-item active">{{ __('admin.teams.add_new') }}</li>
                    </ol>
                </div>
            </div>
            <h3 class="content-header-title mb-0">{{ __('admin.teams.add_new') }}</h3>
        </div>
    </div>
        ...
        <div class="col-md-10">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">{{ __('admin.teams.add_new') }} - {{ $club->name }}</h4>
                </div>
                <div class="card-body">
                    <form action="{{ route('admin.clubs.teams.store', $club->id) }}" method="POST"
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" class="form-control" required
                                        placeholder="e.g. Under 17s" value="{{ old('name') }}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>{{ __('admin.teams.short_name') }}</label>
                                    <input type="text" name="short_name" class="form-control" placeholder="e.g. U17"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="age_group" class="form-control" placeholder="e.g. 2007-2009"
                                        value="{{ old('age_group') }}">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="jersey_color" class="form-control"
                                        placeholder="e.g. Red / White" value="{{ old('jersey_color') }}">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
