                    ...
                    <div class="card-body">
                        ...
                        <div class="progress progress-sm mt-1 mb-0 box-shadow-2">
                            <div class="progress-bar bg-gradient-x-warning" role="progressbar"
                                ...
                                aria-valuenow="{{ $percentages['services'] }}" aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="progress progress-sm mt-1 mb-0 box-shadow-2">
                            <div class="progress-bar bg-gradient-x-success" role="progressbar"
                                ...
                                aria-valuenow="{{ $percentages['requests'] }}" aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card pull-up">
                <div class="card-content">
                    <div class="card-body">
                        ...
                        <div class="progress progress-sm mt-1 mb-0 box-shadow-2">
                            <div class="progress-bar bg-gradient-x-warning" role="progressbar"
                                style="width: {{ $percentages['tickets'] }}%" aria-valuenow="{{ $percentages['tickets'] }}"
                                aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
                    </div>
                </div>
