...
<head>
    ...
    <style>
        ...
        body.blank-page {
            ...
            /* A clean, light grey often used in panels */
        }
    </style>
    <!-- END VENDOR CSS-->
</head>
                            ...
                            <div class="card border-grey border-lighten-3 m-0">
                                <div class="card-header border-0">
                                    <div class="card-title text-center">
                                        <div class="p-1">
                                            <img src="{{asset('app-assets/images/logo.jpeg')}}" alt="branding logo"
                                ...
                                <div class="card-footer">
                                    <div class="">
                                        @if (Route::has('register'))
                                            ...
                                            <p class="float-sm-right text-center m-0">New to Alsa7a? <a
