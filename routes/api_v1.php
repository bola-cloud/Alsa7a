...
|--------------------------------------------------------------------------
|
| These routes are registered twice: once under the /api/v1 prefix, and once
| under /api/v2 so that V2 is a complete superset of V1. api_v2.php is loaded
| after this file, so any route it redefines (the public, country-filtered
| ones) wins over the definition here.
|
*/
